...
public class DetermineSpecies {
	public static void main(String[] args) {
		...
		String[] phenotypes = args[0].split("+");
		...
		for (String specie : leftSpecies) {
			if (specie.equals("human")) {
				System.out.println("Specie: HUMAN - " + (phenotypes.length*100)/humanPhenotypeSize + " match");
			} else if (specie.equals("chimp")) {
				System.out.println("Specie: CHIMP - " + (phenotypes.length*100)/chimpPhenotypeSize + " match");
			} else if (specie.equals("horse")) {
				System.out.println("Specie: HORSE - " + (phenotypes.length*100)/horsePhenotypeSize + " match");
			} else if (specie.equals("orangutan")) {
				System.out.println("Specie: orangutan - " + (phenotypes.length*100)/orangutanPhenotypeSize + " match");
			} else if (specie.equals("bear")) {
				System.out.println("Specie: BEAR - " + (phenotypes.length*100)/bearPhenotypeSize + " match");
			} else {
